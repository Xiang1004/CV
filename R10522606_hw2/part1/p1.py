...
# You will need to report performance for two combinations of features / classifiers.
# It is suggested you code them in this order, as well:
# 1) Tiny image features and nearest neighbor classifier
# 2) Bag of sift features and nearest neighbor classifier

# The starter code does not crash when run unmodified and you can get a preview of how results are presented.
...
# The categories are somewhat sorted by similarity so that the confusion matrix looks more structured
# (indoor and then urban and then rural).
...
# Max is 100. For simplicity, we assume this is the number of test cases per category, as well.
...
def main():
    # This function returns arrays containing the file path for each train and test image,
    # as well as arrays with the label of each train and test image.
    # By default all four of these arrays will be 1500 where each entry is a string.
